...
let carrera = {
    ...
    generarTanda: function(cilindradaMax,pesoMax){
        let autosFiltro1=this.buscarPorCilindrada(cilindradaMax);
        let autosTanda= autosFiltro1.filter(function (elemento){elemento.peso<=pesoMax});
        let rta= autosTanda.length <=this.autosPorTanda ? "tanda OK" : "hay que dividir la tanda"
        return rta;
    },
